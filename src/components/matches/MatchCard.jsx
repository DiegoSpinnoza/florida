...
export function MatchCard({ match }) {
  ...
  return (
    <div 
      className={`border-1 rounded-2xl p-3 sm:p-4 md:p-5 transition-all duration-300 group relative overflow-hidden hover:-translate-y-1 border-[#c7a86b]/20 shadow-md`} 
      style={{
        background: isOsman 
